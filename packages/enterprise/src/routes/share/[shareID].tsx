import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@asgard-code/sdk/v2"
import { SessionTurn } from "@asgard-code/ui/session-turn"
import { SessionReview } from "@asgard-code/ui/session-review"
import { DataProvider } from "@asgard-code/ui/context"
import { DiffComponentProvider } from "@asgard-code/ui/context/diff"
import { CodeComponentProvider } from "@asgard-code/ui/context/code"
import { WorkerPoolProvider } from "@asgard-code/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@asgard-code/ui/logo"
import { IconButton } from "@asgard-code/ui/icon-button"
import { ProviderIcon } from "@asgard-code/ui/provider-icon"
import { createDefaultOptions } from "@asgard-code/ui/pierre"
import { iife } from "@asgard-code/util/iife"
import { Binary } from "@asgard-code/util/binary"
import { NamedError } from "@asgard-code/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@asgard-code/ui/tabs"
import { MessageNav } from "@asgard-code/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@asgard-code/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@asgard-code/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@asgard-code/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@asgard-code/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@asgard-code/ui/pierre/worker").then((m) => ({
